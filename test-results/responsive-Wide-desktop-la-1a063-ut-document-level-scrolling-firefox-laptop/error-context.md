...
- Name: responsive.spec.js >> Wide desktop landing fits without document-level scrolling
- Location: tests/e2e/responsive.spec.js:22:1
...
Locator: getByRole('region', { name: 'Путь от идеи до локального release' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('region', { name: 'Путь от идеи до локального release' })
